...
Student Management System - CRUD Backend (Django REST Framework)
"""
...
# Database - SQLite (as recommended for local dev in the SOP)
DATABASES = {
    "default": {
...
# Allow the plain HTML/CSS/JS frontend (served from a different origin/port)
